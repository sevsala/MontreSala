...
export const PRESET_LOCATIONS: GeoLocation[] = [
  // Israel
  { city: 'Petah Tikva', country: 'Israël', latitude: 32.0919, longitude: 34.8851, timezone: 'Asia/Jerusalem' },
  { city: 'Tel Aviv', country: 'Israël', latitude: 32.0853, longitude: 34.7818, timezone: 'Asia/Jerusalem' },
  { city: 'Jérusalem', country: 'Israël', latitude: 31.7683, longitude: 35.2137, timezone: 'Asia/Jerusalem' },
  { city: 'Netanya', country: 'Israël', latitude: 32.3215, longitude: 34.8532, timezone: 'Asia/Jerusalem' },
  { city: 'Ashdod', country: 'Israël', latitude: 31.8044, longitude: 34.6553, timezone: 'Asia/Jerusalem' },
  { city: 'Haïfa', country: 'Israël', latitude: 32.7940, longitude: 34.9896, timezone: 'Asia/Jerusalem' },
  { city: 'Raanana', country: 'Israël', latitude: 32.1848, longitude: 34.8713, timezone: 'Asia/Jerusalem' },
  { city: 'Herzliya', country: 'Israël', latitude: 32.1663, longitude: 34.8433, timezone: 'Asia/Jerusalem' },
  ...
  { city: 'Strasbourg', country: 'France', latitude: 48.5734, longitude: 7.7521, timezone: 'Europe/Paris' },
  { city: 'Nice', country: 'France', latitude: 43.7102, longitude: 7.2620, timezone: 'Europe/Paris' },
  { city: 'Toulouse', country: 'France', latitude: 43.6047, longitude: 1.4442, timezone: 'Europe/Paris' },

  // International
  { city: 'New York', country: 'États-Unis', latitude: 40.7128, longitude: -74.0060, timezone: 'America/New_York' },
  { city: 'Miami', country: 'États-Unis', latitude: 25.7617, longitude: -80.1918, timezone: 'America/New_York' },
  { city: 'Londres', country: 'Royaume-Uni', latitude: 51.5074, longitude: -0.1278, timezone: 'Europe/London' }
];
